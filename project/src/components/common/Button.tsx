...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'bg-primary-400 text-gray-900 hover:bg-primary-500 focus:ring-primary-500',
    secondary: 'bg-accent-400 text-white hover:bg-accent-500 focus:ring-accent-500',
